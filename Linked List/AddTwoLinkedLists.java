...
public class Main {
    ...
    public static class LinkedList {
        ...
        public static int add2ListHelper(Node l1node, int pvl1, Node l2node, int pvl2, LinkedList ans) {
            if(pvl1 == 0 && pvl2 == 0){
                return 0;
            }
            
            if(pvl1>pvl2){
                //contribution of l1 only
                int carry = add2ListHelper(l1node.next , --pvl1, l2node , pvl2 , ans);
                int val = carry + l1node.data;
                ans.addFirst(val%10);
                return val/10;
                
            }else if(pvl2>pvl1){
                //contribution of l2 only
                int carry = add2ListHelper(l1node,pvl1,l2node.next,--pvl2,ans);
                ...
                //both contribute
                int carry = add2ListHelper(l1node.next,--pvl1,l2node.next,--pvl2,ans);
        ...
        public static LinkedList addTwoLists(LinkedList one, LinkedList two) {
            ...
            int carry = add2ListHelper(one.head, one.size, two.head, two.size, ans);
            if (carry != 0)
                ans.addFirst(carry);
